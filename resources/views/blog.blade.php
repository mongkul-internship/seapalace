...
@section('content')
    ...
    @if(isset($users) & count($users)>0)
        @foreach($users as $user)
            ...
            <div class="container categories_text">
                            ...
                            {{--<div class="col-md-9">--}}
                                {{--<div class="blog_post">--}}
                                    ...
                                    {{--<div class="blog_details">--}}
                                        ...
                                        {{--<a class="button button-blog" href="blog-single.blade.php">View More</a>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        {{--</article>--}}
                                ...
                                {{--<div class="blog_post">--}}
                                    ...
                                    {{--<div class="blog_details">--}}
                                        ...
                                        {{--<p>MCSE boot camps have its supporters and its detractors. Some people do not--}}
                                            ...
                                            {{--study--}}
                                            {{--materials yourself at a fraction.</p>--}}
                                        {{--<a href="blog-single.blade.php" class="button button-blog">View More</a>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        {{--</article>--}}
